...
echo "  3. Accept terms at https://huggingface.co/pyannote/speaker-diarization-community-1"
echo "  4. Accept terms at https://huggingface.co/pyannote/segmentation-3.0"
echo "  5. Get a token at https://huggingface.co/settings/tokens"
echo "  6. Add to .env:  HUGGINGFACE_TOKEN=hf_..."

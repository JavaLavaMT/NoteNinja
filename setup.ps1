...
Write-Host "  3. Accept terms at https://huggingface.co/pyannote/speaker-diarization-community-1"
Write-Host "  4. Accept terms at https://huggingface.co/pyannote/segmentation-3.0"
Write-Host "  5. Get a token at https://huggingface.co/settings/tokens"
Write-Host "  6. Add to .env:  HUGGINGFACE_TOKEN=hf_..."
